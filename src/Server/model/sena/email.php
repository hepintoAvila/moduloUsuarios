 ...
 * @return bool
 */
function envoyerMail($destinataire, $sujet, $corps, $from = '', $headers = '') {
	...
	list($headers, $texte) = mailNormaliserHeaders($headers, $from, $destinataire, $texte, $parts);
 ...
 * @return array
 */
function mailNormaliserHeaders($headers, $from, $to, $texte, $parts = '') {
	$charset = $GLOBALS['meta']['charset'];
