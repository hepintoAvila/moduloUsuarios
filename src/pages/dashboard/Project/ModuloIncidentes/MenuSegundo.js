    ...
    <React.Fragment>
        ...
        <div class="grid_contenedor">
                  <div class="grid_btn1 col-xl-3 col-lg-4 col-sm-6">
                    <MenuBtn texto='Enviar Solicitud' image={avatar3} handleClick={props.handleClick} menuRef={'ModuloIncidentes/EnviarSolicitud'}/>
                  </div>
                  <div class="grid_btn2 col-xl-3 col-lg-4 col-sm-6" >
                    <MenuBtn texto='Consulta de incidente' image={avatar2} handleClick={props.handleClick} menuRef={'ModuloIncidentes/ConsultaIncidente'}/>

                  </div>
                  <div class="grid_btn3 col-xl-3 col-lg-4 col-sm-6">
                    <MenuBtn texto='Reportes' image={avatar1} handleClick={props.handleClick} menuRef={'ModuloIncidentes/ReporteIncidente'}/>
                  </div>
                </div> 
        </Col>
      </Row>
